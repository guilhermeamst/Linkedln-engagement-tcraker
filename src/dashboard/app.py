...
""")
        ...
        st.markdown("---")
        st.caption("Dados desde 01/05/2026, Atualizado dia 21/05/2026")
...
def main() -> None:
    ...
    st.markdown("---")
    st.caption("LinkedIn Engagement Tracker | Dados desde 01/05/2026 | Uso interno")
